...
// MYOAPP_ID=GgQk8Jgwh2Q74W9R9gErzYhbGmT5tXcapR1XMUWKnZ4D anchor build 
declare_id!(anchor_lang::solana_program::pubkey::Pubkey::new_from_array(program_id_from_env!(
    "MYOAPP_ID",
    "973z98ZJYu8bG4EYX5z6pU6NjmCNRd2vFCwJTGqyV9kF" // It's not necessary to change the ID here if you are building using environment variable
)));
